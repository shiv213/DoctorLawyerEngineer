  ...
  return (
    <Layout>
      ...
      <div className="two-grids -contact">
        ...
        <div>
          <form className="contact-form" method="POST" name="contact"><input type="hidden" name="form-name"
                                                                             value="contact"><label
            htmlFor="name">Name</label> <input type="text" name="name" id="name" autoComplete="name"
                                               placeholder="Your name" title="Please enter your name" required="">
            ...
            <input type="email" name="email" id="email" autoComplete="email"
              ...
              <textarea
                name="message" id="message" placeholder="Write your message here" rows="7" required="" />
